"""
Django settings for new_applicationapp__89945 project.
...
ROOT_URLCONF = 'new_applicationapp__89945.urls'
...
WSGI_APPLICATION = 'new_applicationapp__89945.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_applicationapp__89945 API",
    "DESCRIPTION": "API documentation for new_applicationapp__89945 App",
    "VERSION": "v1",
}
