...
## Project Structure
    ...
    ├── new_applicationapp__89945  # Django project configurations
...
1. Clone this repo and `cd new_applicationapp__89945`
...
2. Clone this repo and `cd new_applicationapp__89945`
